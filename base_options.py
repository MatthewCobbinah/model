...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            '--gpu_ids', 
            type=str, 
            default='0', # change to '0' or any id number in help for GPU
            help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU'
        )
        parser.add_argument(
            '--name', 
            type=str, default='experiment_name', 
        ...
        parser.add_argument(
            ...
            type=str, 
            default='cycle_gan', 
            help='chooses which model to use. cycle_gan, test'
        )
        parser.add_argument(
            '--direction', 
            type=str, 
